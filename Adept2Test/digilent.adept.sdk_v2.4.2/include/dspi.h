...
/*  06/07/2011(MichaelA): added DspiSetStartEndDelay and                */
/*      DspiGetStartEndDelay                                            */
/*                                                                      */
/************************************************************************/
...
const DPRP dprpSpiStartEndDelay = 0x00000100; //port supports setting start and end delays
...
DPCAPI  BOOL    DspiSetStartEndDelay(HIF hif, DWORD tusStart, DWORD tusEnd);
DPCAPI  BOOL    DspiGetStartEndDelay(HIF hif, DWORD * ptusStart, DWORD * ptusEnd);
